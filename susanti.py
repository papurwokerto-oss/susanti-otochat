...
# === 7. SUNTIKAN CSS PREMIUM (DIPADATKAN TANPA NEWLINES & KOMENTAR AGAR TIDAK LEAK ATAU EROR SYNTAX) ===
style_html = (
    ...
    "div:has(> button[key='btn_hapus_chat']) {position: fixed !important; bottom: 35px !important; left: 50% !important; transform: translateX(-50%) !important; z-index: 100000 !important; width: auto !important; height: auto !important;}"
    ...
    ".stMainBlockContainer {padding-top: 80px !important; padding-bottom: 200px !important; max-width: 850px !important; margin: 0 auto !important;}"
    ...
    "div[data-testid='stChatInput'] {bottom: 75px !important; background-color: #052217 !important; border-top: 1px solid #0a5d3f !important; padding: 12px 0 !important; z-index: 9999;}"
    ...
    ".custom-footer {position: fixed; bottom: 0; left: 0; right: 0; height: 35px; background-color: #052217; text-align: center; border-top: 1px solid #0a5d3f; z-index: 99998; display: flex; flex-direction: column; justify-content: center;}"
    ".footer-text {font-size: 0.7rem !important; color: #94a3b8 !important; letter-spacing: 0.3px; font-family: 'Inter', sans-serif; margin: 0 !important; line-height: 35px !important;}"
    "</style>"
)
